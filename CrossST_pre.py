...
class SModule(nn.Module):
    def __init__(self, d_model, head, seq_length=1, dropout=0.1):
        ...
        self.spa_attn = PatternAwareAttention(
            d_model, head, seq_length=seq_length
        )
...
class CrossST_pre(nn.Module):
    def __init__(
        ...
        self.predictor = nn.Conv2d(
            d_model, self.output_len, kernel_size=(1, 1)
        )
